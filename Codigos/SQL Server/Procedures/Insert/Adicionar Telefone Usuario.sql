-- ================================================
-- Stored Procedure: sp_AddTelefoneUsuario
...
-- Criação Procedure
CREATE OR ALTER PROCEDURE sp_AddTelefoneUsuario
	-- Telefone Usuario
	@idUsuario INT,
	@telefone CHAR(14)
...
BEGIN
	...
	BEGIN TRY 
		...
		IF EXISTS (
			SELECT 1
			FROM Tbl_Telefone_Usuario WITH (UPDLOCK, HOLDLOCK)
		...
		PRINT 'Telefone do usuário adicionado com sucesso!';
